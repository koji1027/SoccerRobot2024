...
/* Private defines -----------------------------------------------------------*/
#define MAGNETIC_ENCODER_Pin GPIO_PIN_0
...
#define INLB_Pin GPIO_PIN_3
#define INLB_GPIO_Port GPIOB
#define INLA_Pin GPIO_PIN_4
#define INLA_GPIO_Port GPIOB
#define INHC_Pin GPIO_PIN_5
#define INHC_GPIO_Port GPIOB
#define INHB_Pin GPIO_PIN_6
#define INHB_GPIO_Port GPIOB
#define INHA_Pin GPIO_PIN_7
#define INHA_GPIO_Port GPIOB
